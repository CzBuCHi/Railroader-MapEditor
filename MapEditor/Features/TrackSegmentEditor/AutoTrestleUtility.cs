...
public static class AutoTrestleUtility
{
    ...
    public static AutoTrestleData CreateAutoTrestleData(TrackSegment trackSegment, AutoTrestle.AutoTrestle.EndStyle headStyle, AutoTrestle.AutoTrestle.EndStyle tailStyle)
    {
        return CreateOrUpdate(trackSegment, headStyle, tailStyle)(null)!;
    }
}
